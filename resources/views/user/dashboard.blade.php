            ...
            <div class="space-y-3">
                    ...
                    <div class="rounded-lg border border-slate-100 p-4 hover:bg-slate-50 transition duration-150">
                        <div class="flex items-start gap-3">
                            <div class="p-2 rounded-lg 
                                @if(str_contains(strtolower($note->data['title'] ?? ''), 'approved')) bg-emerald-50 text-emerald-600
                                @elseif(str_contains(strtolower($note->data['title'] ?? ''), 'rejected')) bg-red-50 text-red-600
                ...
                @empty
                    <div class="text-center py-8">
                        ...
                        <p class="text-sm text-slate-400 mt-1">You'll see important updates here</p>
                    </div>
                @endforelse
            </div>
        </div>
