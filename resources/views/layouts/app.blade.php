    ...
    <main class="max-w-7xl mx-auto px-4 py-8">
        @if (session('status'))
            <div id="status-toast" class="fixed top-4 right-4 z-50 flex items-center w-full max-w-xs p-4 mb-4 text-green-800 bg-green-50 rounded-lg shadow-lg border border-green-200" role="alert">
                ...
                <div role="button" tabindex="0" class="ml-auto -mx-1.5 -my-1.5 bg-green-50 text-green-500 rounded-lg focus:ring-2 focus:ring-green-400 p-1.5 hover:bg-green-100 inline-flex h-8 w-8 cursor-pointer" onclick="this.parentElement.remove()">
